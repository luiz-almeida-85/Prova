<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="multiplicacao.aspx.cs" Inherits="ProvaWebSistema.multiplicacao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
         ...
         <div class="row">
            <div class="col-md-12">
                <h2 style="color:black">>Multiplicação</h2>
            </div>
        </div>
        <br />
        <br />
        ...
        <asp:Button ID="btnLimpar" runat="server" Text="Limpar" CssClass="btn btn-outline-warning" OnClick="btnLimpar_Click" />
        <br />
        <br />
